...
<!-- <link rel="stylesheet" type="text/css" href="/jsfile/Editor-1.4.2/css/dataTables.editor.min.css"> -->
...
<!-- <link rel='stylesheet' type='text/css' href="<?=$BaseFolder ?>/base.css" /> -->
</head>
...
<!-- <script type="text/javascript" charset="utf8" src="/jsfile/DataTables-1.10.7/media/js/jquery.dataTables.js"></script> -->
<!-- <script type="text/javascript" src="/jsfile/DataTables-1.10.7/extensions/TableTools/js/dataTables.tableTools.min.js"></script> -->
<!-- <script type="text/javascript" src="/jsfile/Editor/js/dataTables.editor.js"></script> -->
...
<script type='text/javascript' src='/jsfile/uploadify/jquery.uploadify.js'></script>
...
<table width=1280px align=center valign=top border=1px>
<?
